        ...
        if( curr > -1 ){
            ...
            if( sections == 1 ){
                ...
                if( work.length > 1 ) {
                    ...
                    if( line === HeaderEnum.resourceIdentifier  && hdr instanceof Header){
                        // Get ID
                        lineEnd = findEndLine(work,0);
                        line = work.slice(0,lineEnd).toString('utf8');
    ...
    */
    ...
    for( h in this.headers.pointerHeaders ){
        if( this.headers.pointerHeaders[h].resourceData instanceof Buffer){
            ...
            resourceBuffer = resourceBuffer.concat('Length: ' , this.headers.pointerHeaders[h].resourceData.length, EndLine + EndLine);
